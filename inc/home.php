        ...
        <div class="container-geral" onclick="menuFecha()">
            <section class="conteudo-principal">
                <div class="area-principal">
                    <!-- <div>
                        <h1 class="titulo animated bounceInDown"> SoftXD </h1>
                    </div> -->
                    <div class="animate-svg">
                    <svg x="0" y="0" fill="none" viewBox="0 0 718.25 213.75">
