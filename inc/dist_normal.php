        ...
        <div class="container-geral">
                <section class="conteudo-principal">
                    <div class="area-principal-descritiva">
                        <form action='./inc.indultiva/inc.distNormal.php' method="POST" class="form-descritiva">
                            <h2 class="titulo-form">Distribuição Normal</h2>
                            <div class="area-info ">
                                <h4 class="titulos">Média</h4>
                                <input type="text" placeholder="Ex:12" name='media' class="inputs">
                            </div>
                            <div class="area-info">
                                <h4 class="titulos">Desvio Padrão</h4>
                                <input type="text" placeholder="Ex:3.2" name='dp' class="inputs">
                            </div>
                            ...
                            <div id='ent' class="area-info entre-div" style='display:none'>
                                ...
                                <input type="text" placeholder="Ex:8" name='b' class="inputs input-dados entre">
